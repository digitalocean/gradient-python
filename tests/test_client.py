...
class TestGradient:
    ...
    def test_copy_default_options(self, client: Gradient) -> None:
    ...
    def test_copy_build_request(self, client: Gradient) -> None:
    ...
    def test_hardcoded_query_params_in_url(self, client: Gradient) -> None:
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = Gradient(base_url=base_url, access_token=access_token, _strict_response_validation=True)
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        non_strict_client = Gradient(base_url=base_url, access_token=access_token, _strict_response_validation=False)
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: Gradient
    ) -> None:
...
class TestAsyncGradient:
    ...
    def test_copy_default_options(self, async_client: AsyncGradient) -> None:
        # options that have a default are overridden correctly
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncGradient) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncGradient) -> None:
    ...
    async def test_copied_client_does_not_close_http(self) -> None:
        test_client = AsyncGradient(base_url=base_url, access_token=access_token, _strict_response_validation=True)
        assert not test_client.is_closed()
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncGradient
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
