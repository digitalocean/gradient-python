...
class TestKeys:
    ...
    def test_method_create(self, client: DigitaloceanGenaiSDK) -> None:
        key = client.genai.providers.openai.keys.create()
    ...
    def test_raw_response_create(self, client: DigitaloceanGenaiSDK) -> None:
        response = client.genai.providers.openai.keys.with_raw_response.create()
    ...
    def test_streaming_response_create(self, client: DigitaloceanGenaiSDK) -> None:
        with client.genai.providers.openai.keys.with_streaming_response.create() as response:
    ...
    def test_method_retrieve(self, client: DigitaloceanGenaiSDK) -> None:
        key = client.genai.providers.openai.keys.retrieve(
            "api_key_uuid",
        )
    ...
    def test_raw_response_retrieve(self, client: DigitaloceanGenaiSDK) -> None:
        response = client.genai.providers.openai.keys.with_raw_response.retrieve(
            "api_key_uuid",
        )
    ...
    def test_streaming_response_retrieve(self, client: DigitaloceanGenaiSDK) -> None:
        with client.genai.providers.openai.keys.with_streaming_response.retrieve(
            "api_key_uuid",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: DigitaloceanGenaiSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `api_key_uuid` but received ''"):
            client.genai.providers.openai.keys.with_raw_response.retrieve(
                "",
            )
    ...
    def test_method_update(self, client: DigitaloceanGenaiSDK) -> None:
        key = client.genai.providers.openai.keys.update(
    ...
    def test_raw_response_update(self, client: DigitaloceanGenaiSDK) -> None:
        response = client.genai.providers.openai.keys.with_raw_response.update(
            path_api_key_uuid="api_key_uuid",
        )
    ...
    def test_streaming_response_update(self, client: DigitaloceanGenaiSDK) -> None:
        with client.genai.providers.openai.keys.with_streaming_response.update(
            path_api_key_uuid="api_key_uuid",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_update(self, client: DigitaloceanGenaiSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_api_key_uuid` but received ''"):
            client.genai.providers.openai.keys.with_raw_response.update(
                path_api_key_uuid="",
            )
    ...
    def test_method_list(self, client: DigitaloceanGenaiSDK) -> None:
        key = client.genai.providers.openai.keys.list()
    ...
    def test_raw_response_list(self, client: DigitaloceanGenaiSDK) -> None:
        response = client.genai.providers.openai.keys.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: DigitaloceanGenaiSDK) -> None:
        with client.genai.providers.openai.keys.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: DigitaloceanGenaiSDK) -> None:
        key = client.genai.providers.openai.keys.delete(
            "api_key_uuid",
        )
    ...
    def test_raw_response_delete(self, client: DigitaloceanGenaiSDK) -> None:
        response = client.genai.providers.openai.keys.with_raw_response.delete(
            "api_key_uuid",
        )
    ...
    def test_streaming_response_delete(self, client: DigitaloceanGenaiSDK) -> None:
        with client.genai.providers.openai.keys.with_streaming_response.delete(
            "api_key_uuid",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: DigitaloceanGenaiSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `api_key_uuid` but received ''"):
            client.genai.providers.openai.keys.with_raw_response.delete(
                "",
            )
    ...
    def test_method_retrieve_agents(self, client: DigitaloceanGenaiSDK) -> None:
        key = client.genai.providers.openai.keys.retrieve_agents(
            uuid="uuid",
        )
    ...
    def test_raw_response_retrieve_agents(self, client: DigitaloceanGenaiSDK) -> None:
        response = client.genai.providers.openai.keys.with_raw_response.retrieve_agents(
            uuid="uuid",
        )
    ...
    def test_streaming_response_retrieve_agents(self, client: DigitaloceanGenaiSDK) -> None:
        with client.genai.providers.openai.keys.with_streaming_response.retrieve_agents(
            uuid="uuid",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve_agents(self, client: DigitaloceanGenaiSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `uuid` but received ''"):
            client.genai.providers.openai.keys.with_raw_response.retrieve_agents(
                uuid="",
            )
...
class TestAsyncKeys:
    ...
    async def test_method_create(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        key = await async_client.genai.providers.openai.keys.create()
        assert_matches_type(KeyCreateResponse, key, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        response = await async_client.genai.providers.openai.keys.with_raw_response.create()
    ...
    async def test_streaming_response_create(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        async with async_client.genai.providers.openai.keys.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        key = await async_client.genai.providers.openai.keys.retrieve(
            "api_key_uuid",
        )
        assert_matches_type(KeyRetrieveResponse, key, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        response = await async_client.genai.providers.openai.keys.with_raw_response.retrieve(
            "api_key_uuid",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        async with async_client.genai.providers.openai.keys.with_streaming_response.retrieve(
            "api_key_uuid",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `api_key_uuid` but received ''"):
            await async_client.genai.providers.openai.keys.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_update(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        key = await async_client.genai.providers.openai.keys.update(
            path_api_key_uuid="api_key_uuid",
        )
        assert_matches_type(KeyUpdateResponse, key, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        response = await async_client.genai.providers.openai.keys.with_raw_response.update(
            path_api_key_uuid="api_key_uuid",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        async with async_client.genai.providers.openai.keys.with_streaming_response.update(
            path_api_key_uuid="api_key_uuid",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `path_api_key_uuid` but received ''"):
            await async_client.genai.providers.openai.keys.with_raw_response.update(
                path_api_key_uuid="",
            )
    ...
    async def test_method_list(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        key = await async_client.genai.providers.openai.keys.list()
        assert_matches_type(KeyListResponse, key, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        response = await async_client.genai.providers.openai.keys.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        async with async_client.genai.providers.openai.keys.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        key = await async_client.genai.providers.openai.keys.delete(
            "api_key_uuid",
        )
        assert_matches_type(KeyDeleteResponse, key, path=["response"])
    ...
    async def test_raw_response_delete(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        response = await async_client.genai.providers.openai.keys.with_raw_response.delete(
            "api_key_uuid",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        async with async_client.genai.providers.openai.keys.with_streaming_response.delete(
            "api_key_uuid",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `api_key_uuid` but received ''"):
            await async_client.genai.providers.openai.keys.with_raw_response.delete(
                "",
            )
    ...
    async def test_method_retrieve_agents(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        key = await async_client.genai.providers.openai.keys.retrieve_agents(
            uuid="uuid",
        )
        assert_matches_type(KeyRetrieveAgentsResponse, key, path=["response"])
    ...
    async def test_raw_response_retrieve_agents(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        response = await async_client.genai.providers.openai.keys.with_raw_response.retrieve_agents(
            uuid="uuid",
        )
    ...
    async def test_streaming_response_retrieve_agents(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        async with async_client.genai.providers.openai.keys.with_streaming_response.retrieve_agents(
            uuid="uuid",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve_agents(self, async_client: AsyncDigitaloceanGenaiSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `uuid` but received ''"):
            await async_client.genai.providers.openai.keys.with_raw_response.retrieve_agents(
                uuid="",
            )
