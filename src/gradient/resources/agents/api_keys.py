...
class APIKeysResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            + path_template("/v2/gen-ai/agents/{path_agent_uuid}/api_keys", path_agent_uuid=path_agent_uuid),
    ...
    def update(
        ...
        *,
        ...
        return self._put(
            ("https://api.digitalocean.com" if not self._client._base_url_overridden else "")
            + path_template(
                "/v2/gen-ai/agents/{path_agent_uuid}/api_keys/{path_api_key_uuid}",
                path_agent_uuid=path_agent_uuid,
                path_api_key_uuid=path_api_key_uuid,
            ),
            body=maybe_transform(
                {
                    "body_agent_uuid": body_agent_uuid,
    ...
    def list(
        ...
        *,
        ...
        return self._get(
            ("https://api.digitalocean.com" if not self._client._base_url_overridden else "")
            + path_template("/v2/gen-ai/agents/{agent_uuid}/api_keys", agent_uuid=agent_uuid),
            options=make_request_options(
