...
from ....types.genai import knowledge_base_list_params, knowledge_base_create_params, knowledge_base_update_params
from ...._base_client import make_request_options
from ....types.genai.knowledge_base_list_response import KnowledgeBaseListResponse
from ....types.genai.knowledge_base_create_response import KnowledgeBaseCreateResponse
from ....types.genai.knowledge_base_delete_response import KnowledgeBaseDeleteResponse
from ....types.genai.knowledge_base_update_response import KnowledgeBaseUpdateResponse
from ....types.genai.knowledge_base_retrieve_response import KnowledgeBaseRetrieveResponse
