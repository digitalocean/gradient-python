...
from ....types.genai.agents.api_link_knowledge_base_output import APILinkKnowledgeBaseOutput
from ....types.genai.agents.knowledge_base_detach_response import KnowledgeBaseDetachResponse
