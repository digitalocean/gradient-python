...
from ....types.genai.agents.function_create_response import FunctionCreateResponse
from ....types.genai.agents.function_delete_response import FunctionDeleteResponse
from ....types.genai.agents.function_update_response import FunctionUpdateResponse
