...
class LoadBalancersResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        algorithm: Literal["round_robin", "least_connections"] | NotGiven = NOT_GIVEN,
        disable_lets_encrypt_dns_records: bool | NotGiven = NOT_GIVEN,
        domains: Iterable[DomainsParam] | NotGiven = NOT_GIVEN,
        droplet_ids: Iterable[int] | NotGiven = NOT_GIVEN,
        enable_backend_keepalive: bool | NotGiven = NOT_GIVEN,
        enable_proxy_protocol: bool | NotGiven = NOT_GIVEN,
        firewall: LbFirewallParam | NotGiven = NOT_GIVEN,
        glb_settings: GlbSettingsParam | NotGiven = NOT_GIVEN,
        health_check: HealthCheckParam | NotGiven = NOT_GIVEN,
        http_idle_timeout_seconds: int | NotGiven = NOT_GIVEN,
        name: str | NotGiven = NOT_GIVEN,
        network: Literal["EXTERNAL", "INTERNAL"] | NotGiven = NOT_GIVEN,
        network_stack: Literal["IPV4", "DUALSTACK"] | NotGiven = NOT_GIVEN,
        project_id: str | NotGiven = NOT_GIVEN,
        redirect_http_to_https: bool | NotGiven = NOT_GIVEN,
        region: Literal[
            "ams1",
            "ams2",
            "ams3",
